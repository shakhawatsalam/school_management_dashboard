...
const TeacherListPage = () => {
  ...
  const renderRow = (item: Teacher) => {
    return (
      <tr key={item.id} className="border-b border-gray-200 even:bg-stone-50 text-sm hover:bg-purpleColorLight">
        ...
        <td className='hidden md:table-cell'>{item.teacharId}</td>
